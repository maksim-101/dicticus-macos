...
- [x] **IOSBG-02**: A backgrounded dictation reliably finalizes and makes its transcript available (no data loss) when the user returns.
- [x] **IOSBG-03**: The background-recording design is validated against App Store review rules (clear user-facing purpose, correct AVAudioSession category) via a spike before implementation.
...
| IOSBG-02 | Phase 36 | Complete |
| IOSBG-03 | Phase 36 | Complete |
