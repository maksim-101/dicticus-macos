...
- [ ] 36-02-PLAN.md — Background-capture foundation: supersede spike scaffolding, no-finalize-on-background, ContentState `startedAt` + `Text(timerInterval:)`, restore silence auto-stop + toggle cleanup (IOSBG-01)
- [ ] 36-03-PLAN.md — No-reopen stop controls: fix expanded/lock-screen Live Activity Stop, Action-Button toggle-to-stop, ~5-min soft cap (IOSBG-01 / D-01, D-01a, D-03)
